...
rec_ubcf_400 <- as(predict(recmod_ubcf_400, train_400, n = 15), 'list')
...
```
Wir sehen, die Recommendations von IBCF und UBCF für unsere 3 User sind fast vollständig unterschiedlich.
