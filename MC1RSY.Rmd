...
approaches <- list(
  ...
  "SVD lambda 0.0001" = list(
    name = "SVD",
    param = list(k = 50, lambda = 0.0001)
  ),
  "SVD lambda def(0.001)" = list(
    name = "SVD",
    param = list(k = 50, lambda = 0.001)
  ),
  "SVD lambda 0.002" = list(
    name = "SVD",
    param = list(k = 50, lambda = 0.002)
  ),
  "SVD lambda 0.005" = list(
    name = "SVD",
    param = list(k = 50, lambda = 0.005)
  ),
  "SVD lambda 0.01" = list(
    name = "SVD",
    param = list(k = 50, lambda = 0.01)
  ),
  "SVD lambda 0.02" = list(
    name = "SVD",
    param = list(k = 50, lambda = 0.02)
  )
)
